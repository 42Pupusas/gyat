...
pub fn login_form() -> Html {
    ...
    html! {
        <>
        <img
            class={classes!("mb-4", "mx-auto", "size-64", "rounded-full", "shadow-lg")}
            src="./public/avocodo.png"
            alt="Rooky Logo" />
        <Card class="bg-gradient-to-r from-yellow-400 to-orange-500 border-4 border-white shadow-2xl rounded-xl max-w-xs md:max-w-sm w-full text-white">
            <CardHeader>
                <CardTitle>{ "Gyat" }</CardTitle>
                <CardDescription>{ "The thiccest bitcoin wallet" }</CardDescription>
            </CardHeader>
            <CardContent>
                <Tabs default_value="register" class={classes!("w-full")}>
                    <TabsList class={classes!("justify-stretch", "w-full", "flex")}>
                        <TabsTrigger class={classes!("bg-gradient-to-r", "hover:bg-gray-200", "from-blue-500", "to-purple-600", "text-white", "border", "border-white")}
                            value="register">{ "New Identity" }</TabsTrigger>
                        <TabsTrigger class={classes!("bg-gradient-to-r", "hover:bg-gray-200", "from-blue-500", "to-purple-600", "text-white", "border", "border-white")}
                            value="login">{ "Recover" }</TabsTrigger>
                    </TabsList>
...
pub fn new_key_form() -> Html {
    ...
    html! {
        <Card class="bg-gradient-to-r from-purple-400 to-pink-500 border-4 border-white shadow-2xl rounded-xl max-w-xs md:max-w-sm w-full text-white">
            <CardHeader>
...
pub fn new_key_form() -> Html {
    ...
    html! {
        <Card class="bg-gradient-to-r from-pink-400 to-purple-600 border-4 border-white shadow-2xl rounded-xl max-w-xs md:max-w-sm w-full text-white">
            <CardHeader>
